...
<div class="col l9 s10 conteudo-do-home">
      ...
      <div class="row">
        <div class="col l12 s12">
          ...
          <tbody>
             <?php
              $status_ro =  $_GET["status"];
              $dat = $_GET["data"];
              $cpf = $_SESSION["cpf"];
              $query = "select * from rotas where agente = '$cpf'  and status_ro = $status_ro and dat_in = '$dat' ORDER BY dat_in DESC;" ;
              ...
              while($row=mysqli_fetch_array($result)){
               ...
               <tr><td><a class="btn-floating teal lighten-5" href="visualizar.php?id=<?php echo $row['cod_rota']?>" ><i class=" material-icons grey darken-1">zoom_in</i></i></a>
                ...
                <?php echo "</td><td>". $row['saida'] ."</td><td>". $row['chegada'] ."</td><td>" . $row['dat_in'] . "</td></tr>";
              }
            ?>
          </tbody>
          </table>
