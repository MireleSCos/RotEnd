...
if(!isset($_SESSION['acesso']) || ($_SESSION['acesso'] != "OK") ) {
  ...
  $_SESSION["acesso"] = "Você não tem permissão para acessar a pagina do Agente!";
  header("Location: inicial.php");
}
?>
<!DOCTYPE html>
      ...
      <ul id="menu-mobile" class="side-nav fixed teal lighten-4">
        <li><div class="user-view">
          ...
          <a href="#!email"><span class="white-text email"><?php $login = $_SESSION["login"]; echo"$login";?></span></a>
		      ...
		      <br>
          <li><a href="home_agente.php"><i class="material-icons">explore</i>Bem vindo, <?php $nome = $_SESSION["nome"]; echo"$nome";?></a></li>
				 <li><div class="divider"></div></li>
            
            <li>
              <a href="Marcar_pontos.php"><i class="material-icons">add_location</i>Nova Rota</a>
            </li>
            <li>
              <a href="rotas.php"><i class="material-icons">beenhere</i>Consultar Rotas</a>
            </li>
            <li>
              <a href="res_obs.php"><i class="material-icons">email</i>Gerente</a>
            </li>
            <li>
              <a href="rotas.php"><i class="material-icons">notifications_active</i>Atendimento</a>
            </li>
            <li>
              <div class="divider">
              </div>
